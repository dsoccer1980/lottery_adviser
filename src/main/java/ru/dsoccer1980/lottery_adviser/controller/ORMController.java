...
public class ORMController {
    ...
    @RequestMapping(value = "/numbersNextAppearance", method = RequestMethod.GET)
    public ModelAndView numbersAverageAppearance(HttpServletRequest request) {
        System.out.println("ORMController numbersNextAppearance is called");
        Map<Integer, Integer> result = ormService.numbersNextAppearance();
